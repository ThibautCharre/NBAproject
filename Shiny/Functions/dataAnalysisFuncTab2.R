...
#-------------------------------------------------------------------------------
  ...
  pointsDT <- data.table(Type = pointsDT$type, 
                         Starter = paste(pointsDT$starterPPG, " pts (", pointsDT$starterEfficiency, "%)", sep = ""), 
                         Bench = paste(pointsDT$benPPG, " pts (", pointsDT$benchEfficiency, "%)", sep = ""), 
                         Total = paste(pointsDT$totalPPG, " pts (", pointsDT$totalEfficiency, "%)", sep = ""))
